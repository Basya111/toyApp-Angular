...
function singup(entityType: string, newEntity: Entity) {
  localStorage.setItem(entityType, JSON.stringify(newEntity))
  return newEntity
}

function logout(entityType: string){
  localStorage.removeItem(entityType)
}

function updateEntity(entityType: string, updatedEntity: Entity){
  localStorage.setItem(entityType, JSON.stringify(updatedEntity))
  return updatedEntity
}
